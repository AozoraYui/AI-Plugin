...
export const Config = {
    ...
    get CHAT_COMMAND() { return config.CHAT_COMMAND ?? 'chat' },
    set CHAT_COMMAND(val) { config.CHAT_COMMAND = val },
    get DRAW_COMMAND() { return config.DRAW_COMMAND ?? 'draw' },
    set DRAW_COMMAND(val) { config.DRAW_COMMAND = val },
