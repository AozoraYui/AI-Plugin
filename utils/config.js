...
export const Config = {
    ...
    get enable_group_send() { return config.enable_group_send ?? defaultConfig.enable_group_send },
    ...
    get SHELL_SESSION_AFTER_SEND_DELAY_MS() { return config.SHELL_SESSION_AFTER_SEND_DELAY_MS ?? defaultConfig.SHELL_SESSION_AFTER_SEND_DELAY_MS },
    set SHELL_SESSION_AFTER_SEND_DELAY_MS(val) { config.SHELL_SESSION_AFTER_SEND_DELAY_MS = Number(val) || defaultConfig.SHELL_SESSION_AFTER_SEND_DELAY_MS },
    get SHELL_SESSION_AFTER_SEND_TIMEOUT_MS() { return config.SHELL_SESSION_AFTER_SEND_TIMEOUT_MS ?? defaultConfig.SHELL_SESSION_AFTER_SEND_TIMEOUT_MS },
